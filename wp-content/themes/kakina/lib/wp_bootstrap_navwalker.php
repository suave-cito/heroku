...
if ( !class_exists( 'kakina_wp_bootstrap_navwalker' ) ) {
class kakina_wp_bootstrap_navwalker extends Walker_Nav_Menu {
	/**
	 ...
	 *
	 */
	public static function kakina_fallback( $args ) {
		if ( current_user_can( 'manage_options' ) ) {
			...
			$fb_output .= '>';
			$fb_output .= '<li><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '">' . esc_html__( 'Add a menu', 'kakina' ) . '</a></li>';
			$fb_output .= '</ul>';
			if ( $container )
				$fb_output .= '</' . $container . '>';
			echo $fb_output;
